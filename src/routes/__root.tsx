...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "WikiFortress — Wikipedia Eligibility Advisory" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "WikiFortress" },
      { property: "og:title", content: "WikiFortress — Wikipedia Eligibility Advisory" },
      {
        property: "og:description",
        content: "Truth before transaction. Evidence-based Wikipedia eligibility evaluation.",
      },
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              (function(){
                ...
                s1.async = true;
                s1.src = 'https://embed.tawk.to/6a85feb427f5991d51f60cfb/1k0dmlsdv';
                s1.charset = 'UTF-8';
